function block_league.HUD_spectate_create(arena, sp_name)
  ...
  for _, pl_name in pairs(arena_lib.get_players_in_team(arena, 1)) do
    block_league.HUD_spectate_addplayer(arena, pl_name, true)
  end
...
function block_league.HUD_spectate_addplayer(arena, p_name, has_spec_just_entered)
  ...
  for sp_name, _ in pairs(arena.spectators) do
    ...
    if not has_spec_just_entered then
